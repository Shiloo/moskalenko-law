...
export default function ContactPage() {
  ...
  async function onSubmit(data: FD) {
    ...
    try {
      ...
      if (r.ok) { setStatus("success"); reset(); }
      ...
      <section className="relative overflow-hidden" style={{ minHeight: "280px" }}>
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(239,246,255,0.97) 0%, rgba(219,234,254,0.94) 40%, rgba(239,246,255,0.91) 100%)",
            }}
          />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <h1 className="text-4xl sm:text-5xl font-extrabold mb-4" style={{ color: "#0A0E1A", letterSpacing: "-0.03em" }}>
              {t("title")}
            </h1>
            <p className="text-lg max-w-xl mx-auto" style={{ color: "#374151" }}>{t("subtitle")}</p>
              ...
              <AnimatedSection>
                <div
                  ...
                  style={{
                    ...
                    boxShadow: "0 8px 24px rgba(15,27,77,0.2)",
                  }}
                >
                      ...
                      <div key={i} className="flex items-center gap-3">
                        ...
                        {"href" in item && item.href ? (
                          <a
                            ...
                            style={{ color: (item as {accent?:boolean}).accent ? "#1D4ED8" : "#374151", fontWeight: (item as {accent?:boolean}).accent ? 600 : undefined }}
                          >
                            {item.val}
                          </a>
                        ) : (
                            ...
                            {methods.map(m => (
                              <button
                                ...
                                style={selMethod === m ? {
                                  ...
                                  border: "none", boxShadow: "0 3px 10px rgba(37,99,235,0.3)",
                                } : {
                                  border: "1.5px solid rgba(37,99,235,0.18)", color: "#1D4ED8", background: "transparent",
                                }}
                              >
                                {m}
                              </button>
