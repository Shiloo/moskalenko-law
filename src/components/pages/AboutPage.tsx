...
import LawBooksIllustration from "@/components/ui/LawBooksIllustration";
...
export default function AboutPage() {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.92 }} animate={{ opacity: 1, scale: 1 }}
              ...
              <div className="relative">
                {/*
                  ╔══════════════════════════════════════════════╗
                  ║  ЗАГЛУШКА — замінити на фото Юлії:          ║
                  ║  1. Помісти фото у public/images/yulia.jpg  ║
                ...
                <AnimatedSection key={i} delay={i * 0.1} direction="left">
                  <div className="flex gap-5 items-start pl-14 relative">
                    <div className="absolute left-3 top-1.5 w-6 h-6 rounded-full flex items-center justify-center shadow-md"
                      style={{ background: "linear-gradient(135deg,#1D4ED8,#2563EB)", boxShadow: "0 0 0 3px rgba(37,99,235,0.12), 0 2px 8px rgba(37,99,235,0.25)" }}>
      ...
      {/* Law Books illustration + Achievements */}
          ...
          <div className="grid lg:grid-cols-5 gap-12 items-start">
            ...
            <div className="lg:col-span-2">
              <AnimatedSection direction="left">
                <LawBooksIllustration className="w-full max-w-sm mx-auto drop-shadow-xl" />
              </AnimatedSection>
            </div>
              ...
              <AnimatedSection key={i} delay={i * 0.1}>
                <div className="p-6 rounded-2xl card-hover text-center"
                  ...
                  <h3 className="font-bold text-base mb-2"
                    style={{ color: i === 1 ? "#93C5FD" : "#1D4ED8" }}>{item.title}</h3>
