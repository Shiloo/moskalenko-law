...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Subtle hero-bg as full background with very light overlay */}
      <div className="absolute inset-0">
        <Image
          ...
          priority
        />
        {/* Heavy light overlay so text is perfectly readable */}
        <div
          className="absolute inset-0"
          style={{
            background:
              "linear-gradient(135deg, rgba(255,255,255,0.97) 0%, rgba(239,246,255,0.95) 50%, rgba(255,255,255,0.93) 100%)",
          }}
        />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              <h1
                className="text-4xl sm:text-5xl lg:text-[3.6rem] font-extrabold leading-[1.06] mb-5"
            ...
            <div className="relative w-full max-w-md">
              ...
              >
                ...
                <div
                  ...
                  style={{ background: "linear-gradient(to bottom, transparent 55%, rgba(10,22,60,0.4) 100%)" }}
                />
                {/* Stats overlay */}
